...
our $CONFIG = {
  ...
  "Linux::DesktopFiles" => {
                             ...
                             gtk_rc_filename         => "/home/jplayer/.gtkrc-2.0",
                             icon_dirs_first         => undef,
                             icon_dirs_last          => undef,
                             icon_dirs_second        => undef,
                             keep_unknown_categories => 1,
                             skip_entry              => undef,
                             skip_filename_re        => qr/^(?:avahi-discover|b(?>vnc|ssh)|dconf-editor|pcmanfm-desktop-pref|exfalso|feh|qv4l2|lxshortcut|libfm-pref-apps|compton|7zFM|zenmap|urxvt(c)?|tilda|jconsole|policytool|.*\-qt4)\b/,
                             skip_svg_icons          => 1,
